...
#the paths here are a TOTAL NIGHTMARE! I don't understand where they are going or what to do about it or whatever
#this shouldn't be so difficult. I guess it's because it's assigning them to different machines.
#but just irritating!
